...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/%40isaacs/balanced-match/">
      
      
        <link rel="prev" href="../../%40humanwhocodes/momoa/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>@isaacs/balanced-match - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#isaacsbalanced-match" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#const-m-balanceda-b-str" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        const m = balanced(a, b, str)
          ...
          <li class="md-nav__item">
  <a href="#const-r-balancedrangea-b-str" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="isaacsbalanced-match">@isaacs/balanced-match</h1>
<p>A hybrid CJS/ESM TypeScript fork of
<a href="http://npm.im/balanced-match">balanced-match</a>.</p>
...
<p><a href="https://github.com/juliangruber/balanced-match/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/juliangruber/balanced-match/actions/workflows/ci.yml/badge.svg" /></a>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">balanced</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;@isaacs/balanced-match&#39;</span>
...
<h2 id="api">API</h2>
<h3 id="const-m-balanceda-b-str">const m = balanced(a, b, str)</h3>
...
<h3 id="const-r-balancedrangea-b-str">const r = balanced.range(a, b, str)</h3>
<p>For the first non-nested matching pair of <code>a</code> and <code>b</code> in <code>str</code>, return an
