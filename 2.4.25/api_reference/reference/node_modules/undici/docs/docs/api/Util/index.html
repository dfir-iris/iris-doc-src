...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/undici/docs/docs/api/Util/">
      
      
        <link rel="prev" href="../RetryHandler/">
      
      
        <link rel="next" href="../WebSocket/">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#parseheadersheaders-obj" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#headernametostringvalue" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="util">Util</h1>
<p>Utility API for third-party implementations of the dispatcher API.</p>
<h2 id="parseheadersheaders-obj"><code>parseHeaders(headers, [obj])</code></h2>
<p>Receives a header object and returns the parsed value.</p>
<p>Arguments:</p>
<ul>
<li>
...
<h2 id="headernametostringvalue"><code>headerNameToString(value)</code></h2>
<p>Retrieves a header name and returns its lowercase value.</p>
<p>Arguments:</p>
<ul>
