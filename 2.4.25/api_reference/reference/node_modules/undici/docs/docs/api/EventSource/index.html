...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/undici/docs/docs/api/EventSource/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>EventSource - Documentation</title>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#instantiating-eventsource" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#using-a-custom-dispatcher" class="md-nav__link">
    <span class="md-ellipsis">
...
<h2 id="instantiating-eventsource">Instantiating EventSource</h2>
<p>Undici exports a EventSource class. You can instantiate the EventSource as
follows:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>import { EventSource } from &#39;undici&#39;
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a>const eventSource = new EventSource(&#39;http://localhost:3000&#39;)
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a>eventSource.onmessage = (event) =&gt; {
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a>  console.log(event.data)
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a>}
</code></pre></div>
<h2 id="using-a-custom-dispatcher">Using a custom Dispatcher</h2>
<p>undici allows you to set your own Dispatcher in the EventSource constructor.</p>
<p>An example which allows you to modify the request headers is:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>import { EventSource, Agent } from &#39;undici&#39;
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a>class CustomHeaderAgent extends Agent {
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a>  dispatch (opts) {
<a id="__codelineno-1-5" name="__codelineno-1-5" href="#__codelineno-1-5"></a>    opts.headers[&#39;x-custom-header&#39;] = &#39;hello world&#39;
<a id="__codelineno-1-6" name="__codelineno-1-6" href="#__codelineno-1-6"></a>    return super.dispatch(...arguments)
<a id="__codelineno-1-7" name="__codelineno-1-7" href="#__codelineno-1-7"></a>  }
<a id="__codelineno-1-8" name="__codelineno-1-8" href="#__codelineno-1-8"></a>}
<a id="__codelineno-1-9" name="__codelineno-1-9" href="#__codelineno-1-9"></a>
<a id="__codelineno-1-10" name="__codelineno-1-10" href="#__codelineno-1-10"></a>const eventSource = new EventSource(&#39;http://localhost:3000&#39;, {
<a id="__codelineno-1-11" name="__codelineno-1-11" href="#__codelineno-1-11"></a>  dispatcher: new CustomHeaderAgent()
