...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/undici/docs/docs/api/BalancedPool/">
      
      
        <link rel="prev" href="../Agent/">
      
      
        <link rel="next" href="../CacheStorage/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>Class: BalancedPool - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#class-balancedpool" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#new-balancedpoolupstreams-options" class="md-nav__link">
    <span class="md-ellipsis">
    ...
    <nav class="md-nav" aria-label="new BalancedPool(upstreams [, options])">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#parameter-balancedpooloptions" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#instance-properties" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Instance Properties">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolupstreams" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.upstreams
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolclosed" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.closed
          ...
          <li class="md-nav__item">
  <a href="#balancedpooldestroyed" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.destroyed
          ...
          <li class="md-nav__item">
  <a href="#poolstats" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#instance-methods" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Instance Methods">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#balancedpooladdupstreamupstream" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.addUpstream(upstream)
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolremoveupstreamupstream" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.removeUpstream(upstream)
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolclosecallback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.close([callback])
          ...
          <li class="md-nav__item">
  <a href="#balancedpooldestroyerror-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.destroy([error, callback])
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolconnectoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.connect(options[, callback])
          ...
          <li class="md-nav__item">
  <a href="#balancedpooldispatchoptions-handlers" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.dispatch(options, handlers)
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolpipelineoptions-handler" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.pipeline(options, handler)
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolrequestoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.request(options[, callback])
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolstreamoptions-factory-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        BalancedPool.stream(options, factory[, callback])
          ...
          <li class="md-nav__item">
  <a href="#balancedpoolupgradeoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="class-balancedpool">Class: BalancedPool</h1>
<p>Extends: <code>undici.Dispatcher</code></p>
<p>A pool of <a href="../Pool/">Pool</a> instances connected to multiple upstreams.</p>
<p>Requests are not guaranteed to be dispatched in order of invocation.</p>
<h2 id="new-balancedpoolupstreams-options"><code>new BalancedPool(upstreams [, options])</code></h2>
<p>Arguments:</p>
<ul>
...
<h3 id="parameter-balancedpooloptions">Parameter: <code>BalancedPoolOptions</code></h3>
<p>Extends: <a href="../Pool/#parameter-pooloptions"><code>PoolOptions</code></a></p>
<ul>
...
<h3 id="balancedpoolupstreams"><code>BalancedPool.upstreams</code></h3>
<p>Returns an array of upstreams that were previously added.</p>
<h3 id="balancedpoolclosed"><code>BalancedPool.closed</code></h3>
<p>Implements <a href="../Client/#clientclosed">Client.closed</a></p>
<h3 id="balancedpooldestroyed"><code>BalancedPool.destroyed</code></h3>
<p>Implements <a href="../Client/#clientdestroyed">Client.destroyed</a></p>
<h3 id="poolstats"><code>Pool.stats</code></h3>
<p>Returns <a href="../PoolStats/"><code>PoolStats</code></a> instance for this pool.</p>
<h2 id="instance-methods">Instance Methods</h2>
<h3 id="balancedpooladdupstreamupstream"><code>BalancedPool.addUpstream(upstream)</code></h3>
<p>Add an upstream.</p>
<p>Arguments:</p>
<ul>
<li><strong>upstream</strong> <code>string</code> - It should only include the <strong>protocol, hostname, and port</strong>.</li>
</ul>
<h3 id="balancedpoolremoveupstreamupstream"><code>BalancedPool.removeUpstream(upstream)</code></h3>
<p>Removes an upstream that was previously added.</p>
<h3 id="balancedpoolclosecallback"><code>BalancedPool.close([callback])</code></h3>
<p>Implements <a href="../Dispatcher/#dispatcherclosecallback-promise"><code>Dispatcher.close([callback])</code></a>.</p>
<h3 id="balancedpooldestroyerror-callback"><code>BalancedPool.destroy([error, callback])</code></h3>
<p>Implements <a href="../Dispatcher/#dispatcherdestroyerror-callback-promise"><code>Dispatcher.destroy([error, callback])</code></a>.</p>
<h3 id="balancedpoolconnectoptions-callback"><code>BalancedPool.connect(options[, callback])</code></h3>
<p>See <a href="../Dispatcher/#dispatcherconnectoptions-callback"><code>Dispatcher.connect(options[, callback])</code></a>.</p>
<h3 id="balancedpooldispatchoptions-handlers"><code>BalancedPool.dispatch(options, handlers)</code></h3>
<p>Implements <a href="../Dispatcher/#dispatcherdispatchoptions-handler"><code>Dispatcher.dispatch(options, handlers)</code></a>.</p>
<h3 id="balancedpoolpipelineoptions-handler"><code>BalancedPool.pipeline(options, handler)</code></h3>
<p>See <a href="../Dispatcher/#dispatcherpipelineoptions-handler"><code>Dispatcher.pipeline(options, handler)</code></a>.</p>
<h3 id="balancedpoolrequestoptions-callback"><code>BalancedPool.request(options[, callback])</code></h3>
<p>See <a href="../Dispatcher/#dispatcherrequestoptions-callback"><code>Dispatcher.request(options [, callback])</code></a>.</p>
<h3 id="balancedpoolstreamoptions-factory-callback"><code>BalancedPool.stream(options, factory[, callback])</code></h3>
...
<h3 id="balancedpoolupgradeoptions-callback"><code>BalancedPool.upgrade(options[, callback])</code></h3>
