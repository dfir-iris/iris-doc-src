...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/%40faker-js/faker/">
      
      
        <link rel="prev" href="../../%40exodus/schemasafe/">
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#try-it-online" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#try-it-online" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#localization" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#setting-a-randomness-seed" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#changelog" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#what-happened-to-the-original-fakerjs" class="md-nav__link">
    <span class="md-ellipsis">
...
<h2 id="try-it-online">⚡️ Try it Online</h2>
<p><a href="https://fakerjs.dev/new"><img alt="" src="https://developer.stackblitz.com/img/open_in_stackblitz.svg" /></a></p>
...
<blockquote>
<p><strong>Note</strong>: Faker tries to generate realistic data and not obvious fake data.
The generated names, addresses, emails, phone numbers, and/or other data might be coincidentally valid information.
Please do not send any of your messages/calls to them from your test setup.</p>
</blockquote>
<h2 id="install">📦 Install</h2>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>npm<span class="w"> </span>install<span class="w"> </span>--save-dev<span class="w"> </span>@faker-js/faker
</code></pre></div>
<h2 id="usage">🪄 Usage</h2>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">faker</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;@faker-js/faker&#39;</span><span class="p">;</span>
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a><span class="c1">// import { faker } from &#39;@faker-js/faker/locale/de&#39;;</span>
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a>
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a><span class="k">export</span><span class="w"> </span><span class="kd">const</span><span class="w"> </span><span class="nx">USERS</span><span class="o">:</span><span class="w"> </span><span class="kt">User</span><span class="p">[]</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">[];</span>
<a id="__codelineno-1-5" name="__codelineno-1-5" href="#__codelineno-1-5"></a>
<a id="__codelineno-1-6" name="__codelineno-1-6" href="#__codelineno-1-6"></a><span class="k">export</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">createRandomUser</span><span class="p">()</span><span class="o">:</span><span class="w"> </span><span class="nx">User</span><span class="w"> </span><span class="p">{</span>
<a id="__codelineno-1-7" name="__codelineno-1-7" href="#__codelineno-1-7"></a><span class="w">  </span><span class="k">return</span><span class="w"> </span><span class="p">{</span>
<a id="__codelineno-1-8" name="__codelineno-1-8" href="#__codelineno-1-8"></a><span class="w">    </span><span class="nx">userId</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.datatype.uuid</span><span class="p">(),</span>
<a id="__codelineno-1-9" name="__codelineno-1-9" href="#__codelineno-1-9"></a><span class="w">    </span><span class="nx">username</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.internet.userName</span><span class="p">(),</span>
<a id="__codelineno-1-10" name="__codelineno-1-10" href="#__codelineno-1-10"></a><span class="w">    </span><span class="nx">email</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.internet.email</span><span class="p">(),</span>
<a id="__codelineno-1-11" name="__codelineno-1-11" href="#__codelineno-1-11"></a><span class="w">    </span><span class="nx">avatar</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.image.avatar</span><span class="p">(),</span>
<a id="__codelineno-1-12" name="__codelineno-1-12" href="#__codelineno-1-12"></a><span class="w">    </span><span class="nx">password</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.internet.password</span><span class="p">(),</span>
<a id="__codelineno-1-13" name="__codelineno-1-13" href="#__codelineno-1-13"></a><span class="w">    </span><span class="nx">birthdate</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.date.birthdate</span><span class="p">(),</span>
<a id="__codelineno-1-14" name="__codelineno-1-14" href="#__codelineno-1-14"></a><span class="w">    </span><span class="nx">registeredAt</span><span class="o">:</span><span class="w"> </span><span class="kt">faker.date.past</span><span class="p">(),</span>
...
<a id="__codelineno-1-18" name="__codelineno-1-18" href="#__codelineno-1-18"></a><span class="nb">Array</span><span class="p">.</span><span class="kr">from</span><span class="p">({</span><span class="w"> </span><span class="nx">length</span><span class="o">:</span><span class="w"> </span><span class="kt">10</span><span class="w"> </span><span class="p">}).</span><span class="nx">forEach</span><span class="p">(()</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<a id="__codelineno-1-19" name="__codelineno-1-19" href="#__codelineno-1-19"></a><span class="w">  </span><span class="nx">USERS</span><span class="p">.</span><span class="nx">push</span><span class="p">(</span><span class="nx">createRandomUser</span><span class="p">());</span>
<a id="__codelineno-1-20" name="__codelineno-1-20" href="#__codelineno-1-20"></a><span class="p">});</span>
</code></pre></div>
<h2 id="modules">💎 Modules</h2>
<p>An in-depth overview of the API methods is available in the <a href="https://fakerjs.dev/guide/">documentation</a>.<br />
The API covers the following modules:</p>
<table>
<thead>
<tr>
<th>Module</th>
...
<td>https://loremflickr.com/640/480/cats <img src="https://loremflickr.com/640/480/cats" height="100"></td>
</tr>
<tr>
<td>Internet</td>
...
<td><code>{ name: 'meter', symbol: 'm' }</code></td>
</tr>
<tr>
<td>System</td>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span>
<a id="__codelineno-2-2" name="__codelineno-2-2" href="#__codelineno-2-2"></a><span class="w">  </span><span class="nx">faker</span><span class="p">.</span><span class="nx">helpers</span><span class="p">.</span><span class="nx">fake</span><span class="p">(</span>
<a id="__codelineno-2-3" name="__codelineno-2-3" href="#__codelineno-2-3"></a><span class="w">    </span><span class="s1">&#39;Hello {{name.prefix}} {{name.lastName}}, how are you today?&#39;</span>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a><span class="c1">// sets locale to de</span>
<a id="__codelineno-3-2" name="__codelineno-3-2" href="#__codelineno-3-2"></a><span class="nx">faker</span><span class="p">.</span><span class="nx">locale</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;de&#39;</span><span class="p">;</span>
</code></pre></div>
<p>See our documentation for a list of <a href="https://fakerjs.dev/guide/localization.html#available-locales">provided languages</a></p>
<p>Please note: not every locale provides data for every module. In our pre-made locales, we fallback to English in such a case as this is the most complete and most commonly used language.</p>
<h2 id="setting-a-randomness-seed">⚙️ Setting a randomness seed</h2>
<p>If you want consistent results, you can set your own seed:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-4-1" name="__codelineno-4-1" href="#__codelineno-4-1"></a><span class="nx">faker</span><span class="p">.</span><span class="nx">seed</span><span class="p">(</span><span class="mf">123</span><span class="p">);</span>
<a id="__codelineno-4-2" name="__codelineno-4-2" href="#__codelineno-4-2"></a>
<a id="__codelineno-4-3" name="__codelineno-4-3" href="#__codelineno-4-3"></a><span class="kd">const</span><span class="w"> </span><span class="nx">firstRandom</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">faker</span><span class="p">.</span><span class="nx">datatype</span><span class="p">.</span><span class="kt">number</span><span class="p">();</span>
<a id="__codelineno-4-4" name="__codelineno-4-4" href="#__codelineno-4-4"></a>
<a id="__codelineno-4-5" name="__codelineno-4-5" href="#__codelineno-4-5"></a><span class="c1">// Setting the seed again resets the sequence.</span>
<a id="__codelineno-4-6" name="__codelineno-4-6" href="#__codelineno-4-6"></a><span class="nx">faker</span><span class="p">.</span><span class="nx">seed</span><span class="p">(</span><span class="mf">123</span><span class="p">);</span>
<a id="__codelineno-4-7" name="__codelineno-4-7" href="#__codelineno-4-7"></a>
<a id="__codelineno-4-8" name="__codelineno-4-8" href="#__codelineno-4-8"></a><span class="kd">const</span><span class="w"> </span><span class="nx">secondRandom</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">faker</span><span class="p">.</span><span class="nx">datatype</span><span class="p">.</span><span class="kt">number</span><span class="p">();</span>
<a id="__codelineno-4-9" name="__codelineno-4-9" href="#__codelineno-4-9"></a>
<a id="__codelineno-4-10" name="__codelineno-4-10" href="#__codelineno-4-10"></a><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">firstRandom</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="nx">secondRandom</span><span class="p">);</span>
</code></pre></div>
...
<p><img alt="" src="https://opencollective.com/fakerjs/organizations.svg" /></p>
<h3 id="backers">Backers</h3>
<p><img alt="" src="https://opencollective.com/fakerjs/individuals.svg" /></p>
<h2 id="contributing">✨ Contributing</h2>
<p>Please make sure to read the <a href="https://github.com/faker-js/faker/blob/main/CONTRIBUTING.md">Contributing Guide</a> before making a pull request.</p>
...
<p>Detailed changes for each release are documented in the <a href="https://github.com/faker-js/faker/blob/main/CHANGELOG.md">release notes</a>.</p>
<h2 id="what-happened-to-the-original-fakerjs">📜 What happened to the original faker.js?</h2>
<p>Read the <a href="https://fakerjs.dev/update.html">team update</a> (January 14th, 2022).</p>
<h2 id="license">🔑 License</h2>
<p><a href="https://github.com/faker-js/faker/blob/main/LICENSE">MIT</a></p>
