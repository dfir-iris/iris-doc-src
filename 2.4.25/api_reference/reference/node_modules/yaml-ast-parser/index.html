...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/yaml-ast-parser/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>yaml-ast-parser - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#yaml-ast-parser" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#yamlnode" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        YAMLNode
          ...
          <li class="md-nav__item">
  <a href="#yamlscalar" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="yaml-ast-parser">yaml-ast-parser</h1>
<p><a href="https://travis-ci.org/mulesoft-labs/yaml-ast-parser"><img alt="Build Status" src="https://travis-ci.org/mulesoft-labs/yaml-ast-parser.svg?branch=master" /></a></p>
<p>This is a fork of JS-YAML which supports parsing of YAML into AST.</p>
<p>In additional to parsing YAML to AST, it has following features:</p>
<ul>
<li>restoration after the errors and reporting errors as a part of AST nodes.</li>
<li>built-in support for <code>!include</code> tag used in RAML</li>
</ul>
<h2 id="usage">Usage</h2>
<p>The type information below is relevant when using TypeScript, if using from JavaScript only the field/method information is relevant.</p>
<p><code>load</code> method can be used to load the tree and returns a <code>YAMLNode</code>.</p>
<h3 id="yamlnode">YAMLNode</h3>
<p><code>YAMLNode</code> class is an ancestor for all node kinds.
It's <code>kind</code> field determine node kind, one of <code>Kind</code> enum:
  * <code>SCALAR</code>, <code>MAPPING</code>, <code>MAP</code>, <code>SEQ</code>, <code>ANCHOR_REF</code> or <code>INCLUDE_REF</code>.</p>
<p>After node kind is determined, it can be cast to one of the <code>YAMLNode</code> descendants types:
 * <code>YAMLScalar</code>, <code>YAMLMapping</code>, <code>YamlMap</code>, <code>YAMLSequence</code> or <code>YAMLAnchorReference</code>.</p>
<table>
<thead>
<tr>
<th>class</th>
<th>important members</th>
</tr>
</thead>
<tbody>
<tr>
<td><code>YAMLNode</code></td>
<td><code>startPosition</code> and <code>endPosition</code> provide node range.</td>
</tr>
<tr>
<td><code>YAMLScalar</code></td>
<td><code>string</code> <code>value</code> field</td>
</tr>
<tr>
<td><code>YAMLMapping</code></td>
<td><code>YAMLScalar</code> <code>key</code> and <code>YAMLNode</code> <code>value</code> fields</td>
</tr>
<tr>
<td><code>YAMLSequence</code></td>
<td><code>YAMLNode[]</code> <code>items</code> field</td>
</tr>
<tr>
<td><code>YamlMap</code></td>
<td><code>YAMLMapping[]</code> <code>mappings</code> field</td>
</tr>
<tr>
<td><code>YAMLAnchorReference</code></td>
<td><code>string</code> <code>referencesAnchor</code> and <code>YAMLNode</code> <code>value</code></td>
</tr>
</tbody>
</table>
<h3 id="yamlscalar">YAMLScalar</h3>
<p>Scalars are <a href="http://www.yaml.org/spec/1.2/spec.html#scalar//">one of the three main node types defined by YAML</a> and are effectively leaf nodes.</p>
<p>There are many factors that can influence the type of datum represent in scalar node (context, schema, tag, etc.).</p>
<p>To help inspection of a <code>YAMLScalar</code> to determine its datatype when a document uses the <a href="http://www.yaml.org/spec/1.2/spec.html#id2804923">Core Schema</a>, you can pass the <code>YAMLScalar</code> to the <code>determineScalarType</code> function.  It will return an enum value indicating <code>null</code>, <code>bool</code>, <code>int</code>, <code>float</code>, or <code>string</code>.</p>
<p>Once you know the type, there are also some helper functions to help read the value by passing them the string, <code>value</code>: <code>parseYamlBoolean</code>, <code>parseYamlFloat</code>, and <code>parseYamlInteger</code>.</p>
