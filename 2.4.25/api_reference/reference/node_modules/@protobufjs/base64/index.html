...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.25/api_reference/reference/node_modules/%40protobufjs/base64/">
      
      
        <link rel="prev" href="../aspromise/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>@protobufjs/base64 - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#protobufjsbase64" class="md-skip">
          Skip to content
        </a>
...
<p><a href="https://www.npmjs.com/package/@protobufjs/base64"><img alt="npm" src="https://img.shields.io/npm/v/@protobufjs/base64.svg" /></a></p>
<p>A minimal base64 implementation for number arrays.</p>
<h2 id="api">API</h2>
<ul>
<li>
<p><strong>base64.length(string: <code>string</code>): <code>number</code></strong><br />
  Calculates the byte length of a base64 encoded string.</p>
</li>
<li>
<p><strong>base64.encode(buffer: <code>Uint8Array</code>, start: <code>number</code>, end: <code>number</code>): <code>string</code></strong><br />
  Encodes a buffer to a base64 encoded string.</p>
</li>
<li>
<p><strong>base64.decode(string: <code>string</code>, buffer: <code>Uint8Array</code>, offset: <code>number</code>): <code>number</code></strong><br />
