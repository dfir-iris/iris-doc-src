...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/should/CONTRIBUTING/">
...
<p>Before contribute something:</p>
<p>Follow simple rules:</p>
<ul>
<li>Not violate <a href="http://programmer.97things.oreilly.com/wiki/index.php/Don%27t_Repeat_Yourself">DRY</a>.</li>
<li>
<p><a href="http://programmer.97things.oreilly.com/wiki/index.php/The_Boy_Scout_Rule">Boy Scout Rule</a> needs to have been applied.</p>
</li>
<li>
<p>Your code should look like all the other code - this project should look like it was written by one person, always.</p>
</li>
<li>If you want to propose something - just create an issue and describe your question with as much description as you can.</li>
<li>Please never send issues or pull requests about code style, jshint violations etc - I do not accept it (and you will spend your time for free).</li>
<li>If you think you have some general improvement, consider creating a pull request with it.</li>
<li>If you are not sure whether your improvement is general enough, just create your own plugin for should.js. (see should.use and Assertion.add usage).</li>
<li>If you add new code, it should be covered by tests. No tests - no code.</li>
<li>If you find a bug (or at least you think it is a bug), create an issue with the library version and test case that I can run and see what are you talking about, or at least full steps by which I can reproduce it.</li>
</ul>
