...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/slugify/">
      
      
        <link rel="prev" href="../simple-websocket/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>slugify - Documentation</title>
...
<p><a href="https://www.npmjs.com/package/slugify"><img alt="npm-version" src="https://img.shields.io/npm/v/slugify.svg?style=flat-square" title="NPM Package Version" /></a> <a href="https://travis-ci.org/simov/slugify"><img alt="travis-ci" src="https://img.shields.io/travis/simov/slugify/master.svg?style=flat-square" title="Build Status - Travis CI" /></a> <a href="https://coveralls.io/r/simov/slugify?branch=master"><img alt="coveralls-status" src="https://img.shields.io/coveralls/simov/slugify.svg?style=flat-square" title="Test Coverage - Coveralls" /></a></p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a><span class="kd">var</span><span class="w"> </span><span class="nx">slugify</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;slugify&#39;</span><span class="p">)</span>
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a><span class="nx">slugify</span><span class="p">(</span><span class="s1">&#39;some string&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// some-string</span>
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a>
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a><span class="c1">// if you prefer something other than &#39;-&#39; as separator</span>
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a><span class="nx">slugify</span><span class="p">(</span><span class="s1">&#39;some string&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;_&#39;</span><span class="p">)</span><span class="w">  </span><span class="c1">// some_string</span>
</code></pre></div>
<ul>
<li>Vanilla ES5 JavaScript</li>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a><span class="nx">slugify</span><span class="p">(</span><span class="s1">&#39;some string&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a><span class="w">  </span><span class="nx">replacement</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;-&#39;</span><span class="p">,</span><span class="w">  </span><span class="c1">// replace spaces with replacement character, defaults to `-`</span>
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a><span class="w">  </span><span class="nx">remove</span><span class="o">:</span><span class="w"> </span><span class="kc">undefined</span><span class="p">,</span><span class="w"> </span><span class="c1">// remove characters that match regex, defaults to `undefined`</span>
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a><span class="w">  </span><span class="nx">lower</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span><span class="w">      </span><span class="c1">// convert to lower case, defaults to `false`</span>
<a id="__codelineno-1-5" name="__codelineno-1-5" href="#__codelineno-1-5"></a><span class="w">  </span><span class="nx">strict</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span><span class="w">     </span><span class="c1">// strip special characters except replacement, defaults to `false`</span>
<a id="__codelineno-1-6" name="__codelineno-1-6" href="#__codelineno-1-6"></a><span class="w">  </span><span class="nx">locale</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;vi&#39;</span><span class="w">       </span><span class="c1">// language code of the locale to use</span>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a><span class="nx">slugify</span><span class="p">(</span><span class="s1">&#39;unicode ♥ is ☢&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// unicode-love-is</span>
</code></pre></div>
<p>However you can extend the supported symbols, or override the existing ones with your own:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a><span class="nx">slugify</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span><span class="s1">&#39;☢&#39;</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;radioactive&#39;</span><span class="p">})</span>
<a id="__codelineno-3-2" name="__codelineno-3-2" href="#__codelineno-3-2"></a><span class="nx">slugify</span><span class="p">(</span><span class="s1">&#39;unicode ♥ is ☢&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// unicode-love-is-radioactive</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-4-1" name="__codelineno-4-1" href="#__codelineno-4-1"></a><span class="ow">delete</span><span class="w"> </span><span class="nx">require</span><span class="p">.</span><span class="nx">cache</span><span class="p">[</span><span class="nx">require</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="s1">&#39;slugify&#39;</span><span class="p">)]</span>
<a id="__codelineno-4-2" name="__codelineno-4-2" href="#__codelineno-4-2"></a><span class="kd">var</span><span class="w"> </span><span class="nx">slugify</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;slugify&#39;</span><span class="p">)</span>
</code></pre></div>
...
<hr />
<blockquote>
<p>This module was originally a vanilla javascript port of <a href="https://github.com/dodo/node-slug">node-slug</a>.<br>
Note that the original <a href="https://www.npmjs.com/package/slug">slug</a> module has been ported to vanilla javascript too.<br>
One major difference between the two modules is that <code>slugify</code> does not depend on the external <a href="https://www.npmjs.com/package/unicode">unicode</a> module.</p>
</blockquote>
