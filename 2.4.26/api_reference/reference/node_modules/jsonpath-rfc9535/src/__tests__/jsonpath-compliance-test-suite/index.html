...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/jsonpath-rfc9535/src/__tests__/jsonpath-compliance-test-suite/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>JSONPath Compliance Test Suite - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#jsonpath-compliance-test-suite" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#contributing" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#non-determinism" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="jsonpath-compliance-test-suite">JSONPath Compliance Test Suite</h1>
<p>This Compliance Test Suite may be used to test implementations of JSONPath
<a href="https://www.rfc-editor.org/rfc/rfc9535">RFC 9535</a>.</p>
<p>See <a href="cts.json">cts.json</a> for the Compliance Test Suite.</p>
<p>See the <a href="CONTRIBUTING/">Contributor Guide</a> if you'd like to submit changes.</p>
<p>To use this test suite, it's recommended you embed this repository as a git submodule of your implementation.</p>
<h3 id="conventions">Conventions</h3>
<p>Basic conventions around source file formatting are captured in the <code>.editorconfig</code> file.
Many editors support that file natively. Others (such as VS code) require a plugin, see https://editorconfig.org/.</p>
<h3 id="contributing">Contributing</h3>
<p>To add or modify a test suite, edit the corresponding file in the <code>tests</code> directory.
To generate <code>cts.json</code>, run the <code>build.sh</code> located in the root folder. Do not modify <code>cts.json</code> directly.
More details are available in the <a href="CONTRIBUTING/">Contributor Guide</a>.</p>
<h3 id="non-determinism">Non-determinism</h3>
<p>Where the spec allows non-deterministic results for a given testcase, the testcase should specify an array of all the valid results (each of which is itself an array representing the resultant nodelist from the query) in the "results" member (and should not specify a "result" member).</p>
