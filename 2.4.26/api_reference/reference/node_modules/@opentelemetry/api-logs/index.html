...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/%40opentelemetry/api-logs/">
      
      
        <link rel="prev" href="../api/">
      
      
        <link rel="next" href="../context-async-hooks/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>OpenTelemetry Logs Bridge API for JavaScript - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#opentelemetry-logs-bridge-api-for-javascript" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#alpha-software-use-at-your-own-risk" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="opentelemetry-logs-bridge-api-for-javascript">OpenTelemetry Logs Bridge API for JavaScript</h1>
<p><a href="https://www.npmjs.com/package/@opentelemetry/api-logs"><img alt="NPM Published Version" src="https://badge.fury.io/js/%40opentelemetry%2Fapi-logs.svg" /></a>
...
<p>This package provides everything needed to interact with the unstable OpenTelemetry Logs Bridge API, including all TypeScript interfaces, enums, and no-op implementations. It is intended for use both on the server and in the browser.</p>
<p><strong>Note: This module defines a log backend API. The API is not intended to be called by application developers directly.
It is provided for logging library authors to build log appenders, which use this API to bridge between existing
logging libraries and the OpenTelemetry log data model.</strong></p>
<h2 id="alpha-software-use-at-your-own-risk">Alpha Software - Use at your own risk</h2>
<p>The Logs Bridge API is considered alpha software and there is no guarantee of stability or long-term support. When the API is stabilized, it will be made available and supported long-term in the <code>@opentelemetry/api</code> package and this package will be deprecated.</p>
<h2 id="quick-start">Quick Start</h2>
<p>Purposefully left blank until SDK is available.</p>
...
<p>If you are writing an instrumentation library, or prefer to call the API methods directly rather than using the <code>register</code> method on the Tracer/Meter/Logger Provider, OpenTelemetry provides direct access to the underlying API methods through the <code>@opentelemetry/api-logs</code> package. API entry points are defined as global singleton objects <code>trace</code>, <code>metrics</code>, <code>logs</code>, <code>propagation</code>, and <code>context</code> which contain methods used to initialize SDK implementations and acquire resources from the API.</p>
<ul>
<li><a href="https://open-telemetry.github.io/opentelemetry-js/modules/_opentelemetry_api_logs.html">Logs API Documentation</a></li>
</ul>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a><span class="kd">const</span><span class="w"> </span><span class="nx">api</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;@opentelemetry/api-logs&quot;</span><span class="p">);</span>
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a><span class="cm">/* A specific implementation of LoggerProvider comes from an SDK */</span>
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a><span class="kd">const</span><span class="w"> </span><span class="nx">loggerProvider</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createLoggerProvider</span><span class="p">();</span>
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a>
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a><span class="cm">/* Initialize LoggerProvider */</span>
<a id="__codelineno-0-7" name="__codelineno-0-7" href="#__codelineno-0-7"></a><span class="nx">api</span><span class="p">.</span><span class="nx">logs</span><span class="p">.</span><span class="nx">setGlobalLoggerProvider</span><span class="p">(</span><span class="nx">loggerProvider</span><span class="p">);</span>
<a id="__codelineno-0-8" name="__codelineno-0-8" href="#__codelineno-0-8"></a><span class="cm">/* returns loggerProvider (no-op if a working provider has not been initialized) */</span>
<a id="__codelineno-0-9" name="__codelineno-0-9" href="#__codelineno-0-9"></a><span class="nx">api</span><span class="p">.</span><span class="nx">logs</span><span class="p">.</span><span class="nx">getLoggerProvider</span><span class="p">();</span>
<a id="__codelineno-0-10" name="__codelineno-0-10" href="#__codelineno-0-10"></a><span class="cm">/* returns a logger from the registered global logger provider (no-op if a working provider has not been initialized) */</span>
<a id="__codelineno-0-11" name="__codelineno-0-11" href="#__codelineno-0-11"></a><span class="kd">const</span><span class="w"> </span><span class="nx">logger</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">api</span><span class="p">.</span><span class="nx">logs</span><span class="p">.</span><span class="nx">getLogger</span><span class="p">(</span><span class="nx">name</span><span class="p">,</span><span class="w"> </span><span class="nx">version</span><span class="p">);</span>
<a id="__codelineno-0-12" name="__codelineno-0-12" href="#__codelineno-0-12"></a>
<a id="__codelineno-0-13" name="__codelineno-0-13" href="#__codelineno-0-13"></a><span class="c1">// logging a log record in a log appender</span>
<a id="__codelineno-0-14" name="__codelineno-0-14" href="#__codelineno-0-14"></a><span class="nx">logger</span><span class="p">.</span><span class="nx">emit</span><span class="p">({</span><span class="w"> </span><span class="nx">severityNumber</span><span class="o">:</span><span class="w"> </span><span class="nx">SeverityNumber</span><span class="p">.</span><span class="nx">TRACE</span><span class="p">,</span><span class="w"> </span><span class="nx">body</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;log data&#39;</span><span class="w"> </span><span class="p">});</span>
</code></pre></div>
