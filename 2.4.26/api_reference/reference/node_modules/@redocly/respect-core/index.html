...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/%40redocly/respect-core/">
      
      
        <link rel="prev" href="../openapi-core/node_modules/picomatch/">
      
      
        <link rel="next" href="node_modules/%40redocly/ajv/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>Respect Your API. Monitor with Confidence - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#respect-your-api-monitor-with-confidence" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#redoclyrespect-core" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#what-is-respect" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="respect-your-api-monitor-with-confidence">Respect Your API. Monitor with Confidence</h1>
<h2 id="redoclyrespect-core"><code>@redocly/respect-core</code></h2>
<p>Continuous API monitoring powered by OpenAPI Arazzo workflows.</p>
<p>This package cannot be used standalone. Please install and use <a href="https://github.com/Redocly/redocly-cli">@redocly/cli</a> to run API tests.</p>
<h2 id="what-is-respect">What is Respect?</h2>
<p>Respect is Redocly's API contract testing system that validates your APIs match their OpenAPI descriptions. It sends real HTTP requests to your API server and compares responses against the expectations defined in your OpenAPI specification and Arazzo workflows.</p>
<ul>
<li>Write tests in human-readable Arazzo format</li>
<li>Get started quickly with auto-generated test workflows</li>
<li>Catch API drift before it breaks your ecosystem</li>
<li>Links API requests to OpenAPI descriptions automatically</li>
<li>Catch problems early in development and CI/CD pipelines</li>
</ul>
<h2 id="requirements">Requirements</h2>
<p>You <strong>MUST</strong> have a working API server running in order to run the tests because Respect sends real HTTP requests.</p>
<h2 id="documentation-and-resources">Documentation and resources</h2>
<ul>
<li><a href="https://redocly.com/docs/respect">Respect documentation</a></li>
<li><a href="https://redocly.com/docs/respect/get-started">Getting started guide</a></li>
<li><a href="https://redocly.com/docs/respect/use-cases">Use cases</a></li>
<li><a href="https://redocly.com/docs/respect/guides/test-api-sequences">Arazzo workflow testing</a></li>
<li><a href="https://redocly.com/docs/respect/commands/respect">Command reference</a></li>
<li><a href="https://redocly.com/respect-cli">Respect CLI overview</a></li>
</ul>
