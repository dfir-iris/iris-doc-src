...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/undici/docs/docs/api/Pool/">
      
      
        <link rel="prev" href="../MockPool/">
      
      
        <link rel="next" href="../PoolStats/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>Class: Pool - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#class-pool" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#new-poolurl-options" class="md-nav__link">
    <span class="md-ellipsis">
    ...
    <nav class="md-nav" aria-label="new Pool(url[, options])">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#parameter-pooloptions" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#instance-properties" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Instance Properties">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#poolclosed" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.closed
          ...
          <li class="md-nav__item">
  <a href="#pooldestroyed" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#instance-methods" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Instance Methods">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#poolclosecallback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.close([callback])
          ...
          <li class="md-nav__item">
  <a href="#pooldestroyerror-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.destroy([error, callback])
          ...
          <li class="md-nav__item">
  <a href="#poolconnectoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.connect(options[, callback])
          ...
          <li class="md-nav__item">
  <a href="#pooldispatchoptions-handler" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.dispatch(options, handler)
          ...
          <li class="md-nav__item">
  <a href="#poolpipelineoptions-handler" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.pipeline(options, handler)
          ...
          <li class="md-nav__item">
  <a href="#poolrequestoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.request(options[, callback])
          ...
          <li class="md-nav__item">
  <a href="#poolstreamoptions-factory-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Pool.stream(options, factory[, callback])
          ...
          <li class="md-nav__item">
  <a href="#poolupgradeoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="class-pool">Class: Pool</h1>
<p>Extends: <code>undici.Dispatcher</code></p>
<p>A pool of <a href="../Client/">Client</a> instances connected to the same upstream target.</p>
<p>Requests are not guaranteed to be dispatched in order of invocation.</p>
<h2 id="new-poolurl-options"><code>new Pool(url[, options])</code></h2>
<p>Arguments:</p>
<ul>
...
<h3 id="parameter-pooloptions">Parameter: <code>PoolOptions</code></h3>
<p>Extends: <a href="../Client/#parameter-clientoptions"><code>ClientOptions</code></a></p>
<ul>
...
<li><strong>interceptors</strong> <code>{ Pool: DispatchInterceptor[] } }</code> - Default: <code>{ Pool: [] }</code> - A list of interceptors that are applied to the dispatch method. Additional logic can be applied (such as, but not limited to: 302 status code handling, authentication, cookies, compression and caching).</li>
</ul>
<h2 id="instance-properties">Instance Properties</h2>
<h3 id="poolclosed"><code>Pool.closed</code></h3>
<p>Implements <a href="../Client/#clientclosed">Client.closed</a></p>
<h3 id="pooldestroyed"><code>Pool.destroyed</code></h3>
...
<h3 id="poolupgradeoptions-callback"><code>Pool.upgrade(options[, callback])</code></h3>
