...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/undici/docs/docs/api/RedirectHandler/">
      
      
        <link rel="prev" href="../ProxyAgent/">
      
      
        <link rel="next" href="../RetryAgent/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>Class: RedirectHandler - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#class-redirecthandler" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#new-redirecthandlerdispatch-maxredirections-opts-handler-redirectionlimitreached" class="md-nav__link">
    <span class="md-ellipsis">
    ...
    <nav class="md-nav" aria-label="new RedirectHandler(dispatch, maxRedirections, opts, handler, redirectionLimitReached)">
  ...
  <a href="#methods" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Methods">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#onconnectabort" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        onConnect(abort)
          ...
          <li class="md-nav__item">
  <a href="#onupgradestatuscode-headers-socket" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        onUpgrade(statusCode, headers, socket)
          ...
          <li class="md-nav__item">
  <a href="#onerrorerror" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        onError(error)
          ...
          <li class="md-nav__item">
  <a href="#onheadersstatuscode-headers-resume-statustext" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        onHeaders(statusCode, headers, resume, statusText)
          ...
          <li class="md-nav__item">
  <a href="#ondatachunk" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        onData(chunk)
          ...
          <li class="md-nav__item">
  <a href="#oncompletetrailers" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        onComplete(trailers)
          ...
          <li class="md-nav__item">
  <a href="#onbodysentchunk" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="class-redirecthandler">Class: RedirectHandler</h1>
<p>A class that handles redirection logic for HTTP requests.</p>
<h2 id="new-redirecthandlerdispatch-maxredirections-opts-handler-redirectionlimitreached"><code>new RedirectHandler(dispatch, maxRedirections, opts, handler, redirectionLimitReached)</code></h2>
<p>Arguments:</p>
<ul>
...
<h4 id="onconnectabort"><code>onConnect(abort)</code></h4>
<p>Called when the connection is established.</p>
<p>Parameters:</p>
<ul>
<li><strong>abort</strong> <code>function</code> - The abort function.</li>
</ul>
<h4 id="onupgradestatuscode-headers-socket"><code>onUpgrade(statusCode, headers, socket)</code></h4>
<p>Called when an upgrade is requested.</p>
<p>Parameters:</p>
<ul>
...
<h4 id="onerrorerror"><code>onError(error)</code></h4>
<p>Called when an error occurs.</p>
<p>Parameters:</p>
<ul>
<li><strong>error</strong> <code>Error</code> - The error that occurred.</li>
</ul>
<h4 id="onheadersstatuscode-headers-resume-statustext"><code>onHeaders(statusCode, headers, resume, statusText)</code></h4>
<p>Called when headers are received.</p>
<p>Parameters:</p>
<ul>
<li><strong>statusCode</strong> <code>number</code> - The HTTP status code.</li>
<li><strong>headers</strong> <code>object</code> - The headers received in the response.</li>
...
<h4 id="ondatachunk"><code>onData(chunk)</code></h4>
<p>Called when data is received.</p>
<p>Parameters:</p>
<ul>
<li><strong>chunk</strong> <code>Buffer</code> - The data chunk received.</li>
</ul>
<h4 id="oncompletetrailers"><code>onComplete(trailers)</code></h4>
<p>Called when the request is complete.</p>
<p>Parameters:</p>
<ul>
<li><strong>trailers</strong> <code>object</code> - The trailers received.</li>
</ul>
<h4 id="onbodysentchunk"><code>onBodySent(chunk)</code></h4>
<p>Called when the request body is sent.</p>
<p>Parameters:</p>
<ul>
