...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/undici/docs/docs/api/WebSocket/">
      
      
        <link rel="prev" href="../Util/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>Class: WebSocket - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#class-websocket" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#new-websocketurl-protocol" class="md-nav__link">
    <span class="md-ellipsis">
    ...
    <nav class="md-nav" aria-label="new WebSocket(url[, protocol])">
...
<h1 id="class-websocket">Class: WebSocket</h1>
<blockquote>
<p>⚠️ Warning: the WebSocket API is experimental.</p>
</blockquote>
<p>Extends: <a href="https://developer.mozilla.org/en-US/docs/Web/API/EventTarget"><code>EventTarget</code></a></p>
...
<h2 id="new-websocketurl-protocol"><code>new WebSocket(url[, protocol])</code></h2>
<p>Arguments:</p>
<ul>
<li><strong>url</strong> <code>URL | string</code> - The url's protocol <em>must</em> be <code>ws</code> or <code>wss</code>.</li>
<li><strong>protocol</strong> <code>string | string[] | WebSocketInit</code> (optional) - Subprotocol(s) to request the server use, or a <a href="../Dispatcher/"><code>Dispatcher</code></a>.</li>
</ul>
<h3 id="example">Example:</h3>
<p>This example will not work in browsers or other platforms that don't allow passing an object.</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>import { WebSocket, ProxyAgent } from &#39;undici&#39;
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a>const proxyAgent = new ProxyAgent(&#39;my.proxy.server&#39;)
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a>
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a>const ws = new WebSocket(&#39;wss://echo.websocket.events&#39;, {
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a>  dispatcher: proxyAgent,
<a id="__codelineno-0-7" name="__codelineno-0-7" href="#__codelineno-0-7"></a>  protocols: [&#39;echo&#39;, &#39;chat&#39;]
<a id="__codelineno-0-8" name="__codelineno-0-8" href="#__codelineno-0-8"></a>})
</code></pre></div>
<p>If you do not need a custom Dispatcher, it's recommended to use the following pattern:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>import { WebSocket } from &#39;undici&#39;
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a>const ws = new WebSocket(&#39;wss://echo.websocket.events&#39;, [&#39;echo&#39;, &#39;chat&#39;])
</code></pre></div>
