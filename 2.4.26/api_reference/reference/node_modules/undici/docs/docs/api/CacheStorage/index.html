...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/undici/docs/docs/api/CacheStorage/">
      
      
        <link rel="prev" href="../BalancedPool/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>CacheStorage - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#cachestorage" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#opening-a-cache" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#deleting-a-cache" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="cachestorage">CacheStorage</h1>
<p>Undici exposes a W3C spec-compliant implementation of <a href="https://developer.mozilla.org/en-US/docs/Web/API/CacheStorage">CacheStorage</a> and <a href="https://developer.mozilla.org/en-US/docs/Web/API/Cache">Cache</a>.</p>
<h2 id="opening-a-cache">Opening a Cache</h2>
<p>Undici exports a top-level CacheStorage instance. You can open a new Cache, or duplicate a Cache with an existing name, by using <code>CacheStorage.prototype.open</code>. If you open a Cache with the same name as an already-existing Cache, its list of cached Responses will be shared between both instances.</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>import { caches } from &#39;undici&#39;
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a>const cache_1 = await caches.open(&#39;v1&#39;)
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a>const cache_2 = await caches.open(&#39;v1&#39;)
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a>
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a>// Although .open() creates a new instance,
<a id="__codelineno-0-7" name="__codelineno-0-7" href="#__codelineno-0-7"></a>assert(cache_1 !== cache_2)
<a id="__codelineno-0-8" name="__codelineno-0-8" href="#__codelineno-0-8"></a>// The same Response is matched in both.
<a id="__codelineno-0-9" name="__codelineno-0-9" href="#__codelineno-0-9"></a>assert.deepStrictEqual(await cache_1.match(&#39;/req&#39;), await cache_2.match(&#39;/req&#39;))
</code></pre></div>
<h2 id="deleting-a-cache">Deleting a Cache</h2>
<p>If a Cache is deleted, the cached Responses/Requests can still be used.</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>const response = await cache_1.match(&#39;/req&#39;)
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>await caches.delete(&#39;v1&#39;)
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a>
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a>await response.text() // the Response&#39;s body
</code></pre></div>
