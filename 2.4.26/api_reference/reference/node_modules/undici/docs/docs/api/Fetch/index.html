...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/undici/docs/docs/api/Fetch/">
      
      
        <link rel="prev" href="../EventSource/">
      
      
        <link rel="next" href="../MockAgent/">
...
<p>Undici exposes a fetch() method starts the process of fetching a resource from the network.</p>
...
<p>This API is implemented as per the standard, you can find documentation on <a href="https://developer.mozilla.org/en-US/docs/Web/API/FormData">MDN</a>.</p>
...
<p>This API is implemented as per the standard, you can find documentation on <a href="https://developer.mozilla.org/en-US/docs/Web/API/Response">MDN</a></p>
<h2 id="request">Request</h2>
<p>This API is implemented as per the standard, you can find documentation on <a href="https://developer.mozilla.org/en-US/docs/Web/API/Request">MDN</a></p>
<h2 id="header">Header</h2>
<p>This API is implemented as per the standard, you can find documentation on <a href="https://developer.mozilla.org/en-US/docs/Web/API/Headers">MDN</a></p>
<h1 id="body-mixins">Body Mixins</h1>
<p><code>Response</code> and <code>Request</code> body inherit body mixin methods. These methods include:</p>
<ul>
...
<p>There is an ongoing discussion regarding <code>.formData()</code> and its usefulness and performance in server environments. It is recommended to use a dedicated library for parsing <code>multipart/form-data</code> bodies, such as <a href="https://www.npmjs.com/package/busboy">Busboy</a> or <a href="https://www.npmjs.com/package/@fastify/busboy">@fastify/busboy</a>.</p>
<p>These libraries can be interfaced with fetch with the following example code:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>import { Busboy } from &#39;@fastify/busboy&#39;
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>import { Readable } from &#39;node:stream&#39;
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a>
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a>const response = await fetch(&#39;...&#39;)
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a>const busboy = new Busboy({
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a>  headers: {
<a id="__codelineno-0-7" name="__codelineno-0-7" href="#__codelineno-0-7"></a>    &#39;content-type&#39;: response.headers.get(&#39;content-type&#39;)
<a id="__codelineno-0-8" name="__codelineno-0-8" href="#__codelineno-0-8"></a>  }
<a id="__codelineno-0-9" name="__codelineno-0-9" href="#__codelineno-0-9"></a>})
<a id="__codelineno-0-10" name="__codelineno-0-10" href="#__codelineno-0-10"></a>
<a id="__codelineno-0-11" name="__codelineno-0-11" href="#__codelineno-0-11"></a>Readable.fromWeb(response.body).pipe(busboy)
</code></pre></div>
