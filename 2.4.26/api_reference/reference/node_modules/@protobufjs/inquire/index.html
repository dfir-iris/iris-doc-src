...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/%40protobufjs/inquire/">
      
      
        <link rel="prev" href="../float/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>@protobufjs/inquire - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#protobufjsinquire" class="md-skip">
          Skip to content
        </a>
...
<p><a href="https://www.npmjs.com/package/@protobufjs/inquire"><img alt="npm" src="https://img.shields.io/npm/v/@protobufjs/inquire.svg" /></a></p>
<p>Requires a module only if available and hides the require call from bundlers.</p>
<h2 id="api">API</h2>
<ul>
<li><strong>inquire(moduleName: <code>string</code>): <code>?Object</code></strong><br />
