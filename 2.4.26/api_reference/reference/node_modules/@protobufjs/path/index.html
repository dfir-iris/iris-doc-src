...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/%40protobufjs/path/">
      
      
        <link rel="prev" href="../inquire/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>@protobufjs/path - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#protobufjspath" class="md-skip">
          Skip to content
        </a>
...
<p><a href="https://www.npmjs.com/package/@protobufjs/path"><img alt="npm" src="https://img.shields.io/npm/v/@protobufjs/path.svg" /></a></p>
<p>A minimal path module to resolve Unix, Windows and URL paths alike.</p>
<h2 id="api">API</h2>
<ul>
<li>
<p><strong>path.isAbsolute(path: <code>string</code>): <code>boolean</code></strong><br />
  Tests if the specified path is absolute.</p>
</li>
<li>
<p><strong>path.normalize(path: <code>string</code>): <code>string</code></strong><br />
  Normalizes the specified path.</p>
</li>
<li>
<p><strong>path.resolve(originPath: <code>string</code>, includePath: <code>string</code>, [alreadyNormalized=false: <code>boolean</code>]): <code>string</code></strong><br />
