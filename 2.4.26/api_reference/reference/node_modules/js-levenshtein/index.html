...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/js-levenshtein/">
      
      
        <link rel="prev" href="../jackspeak/LICENSE/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>js-levenshtein Build Status - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#js-levenshtein" class="md-skip">
          Skip to content
        </a>
...
<h1 id="js-levenshtein">js-levenshtein <a href="https://travis-ci.org/gustf/js-levenshtein"><img alt="Build Status" src="https://travis-ci.org/gustf/js-levenshtein.svg?branch=master" /></a></h1>
<p>A very efficient JS implementation calculating the Levenshtein distance, i.e. the difference between two strings.</p>
<p>Based on Wagner-Fischer dynamic programming algorithm, optimized for speed and memory
 - use a single distance vector instead of a matrix
 - loop unrolling on the outer loop
 - remove common prefixes/postfixes from the calculation
 - minimize the number of comparisons</p>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>$ npm install --save js-levenshtein
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a><span class="kd">const</span><span class="w"> </span><span class="nx">levenshtein</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;js-levenshtein&#39;</span><span class="p">);</span>
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a><span class="nx">levenshtein</span><span class="p">(</span><span class="s1">&#39;kitten&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;sitting&#39;</span><span class="p">);</span>
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a><span class="c1">//=&gt; 3</span>
</code></pre></div>
...
<a id="__codelineno-2-3" name="__codelineno-2-3" href="#__codelineno-2-3"></a>                      50 paragraphs, length max=500 min=240 avr=372.5
<a id="__codelineno-2-4" name="__codelineno-2-4" href="#__codelineno-2-4"></a>             162 op/s » js-levenshtein
<a id="__codelineno-2-5" name="__codelineno-2-5" href="#__codelineno-2-5"></a>              98 op/s » talisman
<a id="__codelineno-2-6" name="__codelineno-2-6" href="#__codelineno-2-6"></a>              94 op/s » levenshtein-edit-distance
<a id="__codelineno-2-7" name="__codelineno-2-7" href="#__codelineno-2-7"></a>              85 op/s » leven
<a id="__codelineno-2-8" name="__codelineno-2-8" href="#__codelineno-2-8"></a>              39 op/s » fast-levenshtein
<a id="__codelineno-2-9" name="__codelineno-2-9" href="#__codelineno-2-9"></a>
<a id="__codelineno-2-10" name="__codelineno-2-10" href="#__codelineno-2-10"></a>                      100 sentences, length max=170 min=6 avr=57.5
<a id="__codelineno-2-11" name="__codelineno-2-11" href="#__codelineno-2-11"></a>           3,076 op/s » js-levenshtein
<a id="__codelineno-2-12" name="__codelineno-2-12" href="#__codelineno-2-12"></a>           2,024 op/s » talisman
<a id="__codelineno-2-13" name="__codelineno-2-13" href="#__codelineno-2-13"></a>           1,817 op/s » levenshtein-edit-distance
<a id="__codelineno-2-14" name="__codelineno-2-14" href="#__codelineno-2-14"></a>           1,633 op/s » leven
<a id="__codelineno-2-15" name="__codelineno-2-15" href="#__codelineno-2-15"></a>             800 op/s » fast-levenshtein
<a id="__codelineno-2-16" name="__codelineno-2-16" href="#__codelineno-2-16"></a>
<a id="__codelineno-2-17" name="__codelineno-2-17" href="#__codelineno-2-17"></a>                      2000 words, length max=20 min=3 avr=9.5
<a id="__codelineno-2-18" name="__codelineno-2-18" href="#__codelineno-2-18"></a>           3,119 op/s » js-levenshtein
<a id="__codelineno-2-19" name="__codelineno-2-19" href="#__codelineno-2-19"></a>           2,416 op/s » talisman
<a id="__codelineno-2-20" name="__codelineno-2-20" href="#__codelineno-2-20"></a>           2,141 op/s » levenshtein-edit-distance
<a id="__codelineno-2-21" name="__codelineno-2-21" href="#__codelineno-2-21"></a>           1,855 op/s » leven
<a id="__codelineno-2-22" name="__codelineno-2-22" href="#__codelineno-2-22"></a>           1,260 op/s » fast-levenshtein
</code></pre></div>
