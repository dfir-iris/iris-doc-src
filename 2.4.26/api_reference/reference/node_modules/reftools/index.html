...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/reftools/">
      
      
        <link rel="prev" href="../redoc/node_modules/minimatch/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>RefTools - Documentation</title>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#typedefs" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#nopobj" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#cloneobj" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#shallowcloneobj" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#deepcloneobj" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#fastcloneobj" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#circularclone" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#dereferenceo" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#flattenobj-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#jpescapes" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#jpunescapes" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#jptrobj-prop-newvalue" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#recurseobject-state-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#rerefobj-options" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#objtographobj-containername" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#visitobj-comparison-callbacks" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#result-result" class="md-nav__link">
    <span class="md-ellipsis">
...
<p><a name="nop"></a></p>
<h2 id="nopobj">nop(obj) ⇒</h2>
<p>a no-op placeholder which returns the given object unchanged
useful for when a clone function needs to be passed but cloning is not
required</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the input object, unchanged  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>obj</td>
<td>the input object</td>
</tr>
</tbody>
</table>
<p><a name="clone"></a></p>
<h2 id="cloneobj">clone(obj) ⇒</h2>
<p>clones the given object using JSON.parse and JSON.stringify</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the cloned object  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>obj</td>
<td>the object to clone</td>
</tr>
</tbody>
</table>
<p><a name="shallowClone"></a></p>
<h2 id="shallowcloneobj">shallowClone(obj) ⇒</h2>
<p>clones the given object's properties shallowly, ignores properties from prototype</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the cloned object  </p>
<table>
<thead>
...
<h2 id="deepcloneobj">deepClone(obj) ⇒</h2>
<p>clones the given object's properties deeply, ignores properties from prototype</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the cloned object  </p>
<table>
<thead>
...
<p><a name="fastClone"></a></p>
<h2 id="fastcloneobj">fastClone(obj) ⇒</h2>
<p>clones the given object's properties shallowly, using Object.assign</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the cloned object  </p>
<table>
<thead>
...
<p><a name="circularClone"></a></p>
<h2 id="circularclone">circularClone()</h2>
<p>Source: stackoverflow http://bit.ly/2A1Kha6</p>
<p><strong>Kind</strong>: global function<br />
<a name="dereference"></a></p>
<h2 id="dereferenceo">dereference(o) ⇒</h2>
<p>dereferences the given object</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the dereferenced object<br />
<strong>Definitions</strong>: a source of definitions to reference<br />
<strong>Options</strong>: optional settings (used recursively)  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<h2 id="flattenobj-callback">flatten(obj, callback) ⇒</h2>
<p>flattens an object into an array of properties</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the flattened object as an array of properties  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>obj</td>
<td>the object to flatten</td>
</tr>
<tr>
<td>callback</td>
<td>a function which can mutate or filter the entries (by returning null)</td>
</tr>
</tbody>
</table>
<p><a name="jpescape"></a></p>
<h2 id="jpescapes">jpescape(s) ⇒</h2>
<p>escapes JSON Pointer using ~0 for ~ and ~1 for /</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the escaped string  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<p><a name="jpunescape"></a></p>
<h2 id="jpunescapes">jpunescape(s) ⇒</h2>
<p>unescapes JSON Pointer using ~0 for ~ and ~1 for /</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the unescaped string  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<p><a name="jptr"></a></p>
<h2 id="jptrobj-prop-newvalue">jptr(obj, prop, newValue) ⇒</h2>
<p>from obj, return the property with a JSON Pointer prop, optionally setting it
to newValue</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the found property, or false  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>obj</td>
<td>the object to point into</td>
</tr>
<tr>
<td>prop</td>
<td>the JSON Pointer or JSON Reference</td>
</tr>
<tr>
<td>newValue</td>
<td>optional value to set the property to</td>
</tr>
</tbody>
</table>
<p><a name="recurse"></a></p>
<h2 id="recurseobject-state-callback">recurse(object, state, callback)</h2>
<p>recurses through the properties of an object, given an optional starting state
anything you pass in state.payload is passed to the callback each time</p>
...
<tr>
<td>object</td>
<td>the object to recurse through</td>
</tr>
<tr>
<td>state</td>
<td>optional starting state, can be set to null or</td>
</tr>
<tr>
<td>callback</td>
<td>the function which receives object,key,state on each property</td>
</tr>
</tbody>
</table>
<p><a name="reref"></a></p>
<h2 id="rerefobj-options">reref(obj, options) ⇒</h2>
<p>Simply modifies an object to have no self-references by replacing them
with $ref pointers</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the re-referenced object (mutated)  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>obj</td>
<td>the object to re-reference</td>
</tr>
<tr>
<td>options</td>
<td>may contain a prefix property for the generated refs</td>
</tr>
</tbody>
</table>
<p><a name="objToGraph"></a></p>
<h2 id="objtographobj-containername">objToGraph(obj, containerName) ⇒</h2>
<p>Takes an object and creates a graph of JSON Pointer / References</p>
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the graph suitable for passing to toposort()  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>containerName</td>
<td>the property containing definitions. Default: definitions</td>
</tr>
</tbody>
</table>
<p><a name="visit"></a></p>
<h2 id="visitobj-comparison-callbacks">visit(obj, comparison, callbacks) ⇒</h2>
<p>Given an expanded object and an optional object to compare to (e.g. its $ref'd form), will call
...
<p><strong>Kind</strong>: global function<br />
<strong>Returns</strong>: the possibly mutated object  </p>
<table>
<thead>
<tr>
<th>Param</th>
...
<tr>
<td>obj</td>
<td>the object to visit</td>
</tr>
<tr>
<td>comparison</td>
<td>optional object to compare to</td>
</tr>
<tr>
<td>callbacks</td>
<td>object containing functions as above</td>
</tr>
</tbody>
</table>
<p><a name="Result"></a></p>
<h2 id="result-result">Result ⇒ <a href="#Result"><code>Result</code></a></h2>
<p>Try to get a topological sorting out of directed graph.</p>
...
<td>A list of nodes, including edges (see below).</td>
</tr>
</tbody>
</table>
...
<td>the sort, empty if not found</td>
</tr>
<tr>
<td>nodesWithEdges,</td>
<td><code>array</code></td>
<td>will be empty unless a cycle is found</td>
</tr>
</tbody>
</table>
