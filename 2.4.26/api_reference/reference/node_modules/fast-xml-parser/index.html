...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/fast-xml-parser/">
      
      
        <link rel="prev" href="../fast-uri/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>fast-xml-parser - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#fast-xml-parser" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#xml-parser" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        XML Parser
          ...
          <li class="md-nav__item">
  <a href="#xml-builder" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#usage-trend" class="md-nav__link">
    <span class="md-ellipsis">
...
<a href="https://coveralls.io/github/NaturalIntelligence/fast-xml-parser?branch=master"><img alt="Coverage Status" src="https://coveralls.io/repos/github/NaturalIntelligence/fast-xml-parser/badge.svg?branch=master" /></a>
...
<a href="https://npm.im/fast-xml-parser"><img alt="NPM total downloads" src="https://img.shields.io/npm/dt/fast-xml-parser.svg" /></a></p>
...
<p><img alt="fxp_sponsors" src="https://raw.githubusercontent.com/NaturalIntelligence/ThankYouBackers/main/assets/NI_sponsors.jpg" />
- <a href="https://github.com/cocopon" target="_blank">Hiroki Kokubun</a></p>
<blockquote>
...
<code>$ npm install fast-xml-parser</code> 
or 
<code>$ yarn add fast-xml-parser</code></p>
<p>To use as system command
<code>$ npm install fast-xml-parser -g</code> </p>
<p>To use it on a <strong>webpage</strong> include it from a <a href="https://cdnjs.com/libraries/fast-xml-parser">CDN</a></p>
<p><strong>Example</strong></p>
<p>As CLI command
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>$<span class="w"> </span>fxparser<span class="w"> </span>some.xml
</code></pre></div></p>
<p>In a node js project
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a><span class="kd">const</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">XMLParser</span><span class="p">,</span><span class="w"> </span><span class="nx">XMLBuilder</span><span class="p">,</span><span class="w"> </span><span class="nx">XMLValidator</span><span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;fast-xml-parser&quot;</span><span class="p">);</span>
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a><span class="kd">const</span><span class="w"> </span><span class="nx">parser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">XMLParser</span><span class="p">();</span>
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a><span class="kd">let</span><span class="w"> </span><span class="nx">jObj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">parser</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">XMLdata</span><span class="p">);</span>
<a id="__codelineno-1-5" name="__codelineno-1-5" href="#__codelineno-1-5"></a>
<a id="__codelineno-1-6" name="__codelineno-1-6" href="#__codelineno-1-6"></a><span class="kd">const</span><span class="w"> </span><span class="nx">builder</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">XMLBuilder</span><span class="p">();</span>
<a id="__codelineno-1-7" name="__codelineno-1-7" href="#__codelineno-1-7"></a><span class="kd">const</span><span class="w"> </span><span class="nx">xmlContent</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">builder</span><span class="p">.</span><span class="nx">build</span><span class="p">(</span><span class="nx">jObj</span><span class="p">);</span>
</code></pre></div></p>
<p>In a HTML page
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;path/to/fxp.min.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
...
<a id="__codelineno-2-4" name="__codelineno-2-4" href="#__codelineno-2-4"></a><span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">parser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">fxparser</span><span class="p">.</span><span class="nx">XMLParser</span><span class="p">();</span>
<a id="__codelineno-2-5" name="__codelineno-2-5" href="#__codelineno-2-5"></a><span class="w">  </span><span class="nx">parser</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">xmlContent</span><span class="p">);</span>
<a id="__codelineno-2-6" name="__codelineno-2-6" href="#__codelineno-2-6"></a><span class="p">&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</code></pre></div></p>
<p>Bundle size</p>
<table>
<thead>
...
<p><img src="./docs/imgs/XMLBuilder_v4.png" width="50%" />
* Y-axis: requests per second</p>
...
<p>This project exists thanks to <a href="graphs/contributors">all</a> the people who contribute. [<a href="docs/CONTRIBUTING.md">Contribute</a>].</p>
...
<p><img alt="Donate $5" src="static/img/donation_quote.png" /></p>
