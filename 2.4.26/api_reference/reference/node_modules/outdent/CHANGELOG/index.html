...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.26/api_reference/reference/node_modules/outdent/CHANGELOG/">
      
      
        <link rel="prev" href="../">
      
      
        <link rel="next" href="../../package-json-from-dist/">
...
<ul>
<li>Update README</li>
<li>Publish to <a href="https://deno.land/x/outdent">deno.land/x</a></li>
</ul>
...
<ul>
<li>Improve internal caching.  outdent will avoid re-computing indentation removal in more situations.</li>
<li>Add <code>newline</code> option for normalizing newlines in template literals.</li>
</ul>
<h2 id="v060">v0.6.0</h2>
<ul>
<li>Adds missing tsconfig files to npm packages.  These will be picked up if / when someone steps their debugger into <code>outdent</code>'s source.</li>
<li>Enable declarationMap: "Go to declaration" should jump to the appropriate source code location.</li>
<li>Fixes webpack bundling support.</li>
</ul>
<h2 id="050">0.5.0</h2>
<ul>
<li>Adds <code>string</code> method for removing indentation from plain strings (thanks @treshugart <a href="https://github.com/cspotcode/outdent/pull/8">#8</a>)</li>
</ul>
<hr />
<p>I didn't maintain a changelog before this point, sorry!</p>
