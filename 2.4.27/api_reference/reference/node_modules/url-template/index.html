...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.27/api_reference/reference/node_modules/url-template/">
      
      
        <link rel="prev" href="../undici-types/">
      
      
        <link rel="next" href="uritemplate-test/">
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#a-javascript-uri-template-implementation" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#a-javascript-uri-template-implementation" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#example" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#a-note-on-error-handling-and-reporting" class="md-nav__link">
    <span class="md-ellipsis">
...
<h2 id="a-javascript-uri-template-implementation">A JavaScript URI template implementation</h2>
<p>This is a simple URI template implementation following the <a href="http://tools.ietf.org/html/rfc6570">RFC 6570 URI Template specification</a>. The implementation supports all levels defined in the specification and is extensively tested.</p>
<h2 id="installation">Installation</h2>
<p>For use with Node.js you can install it through npm:</p>
<div class="highlight"><pre><span></span><code>$ npm install url-template
</code></pre></div>
<p>If you want to use it in a browser, copy <code>lib/url-template.js</code> into your project and use the global <code>urltemplate</code> instance. Alternatively you can use <a href="http://bower.io/">Bower</a> to install this package:</p>
<div class="highlight"><pre><span></span><code>$ bower install url-template
</code></pre></div>
<h2 id="example">Example</h2>
<div class="highlight"><pre><span></span><code>var template = require(&#39;url-template&#39;);
...
<h2 id="a-note-on-error-handling-and-reporting">A note on error handling and reporting</h2>
<p>The RFC states that errors in the templates could optionally be handled and reported to the user. This implementation takes a slightly different approach in that it tries to do a best effort template expansion and leaves erroneous expressions in the returned URI instead of throwing errors. So for example, the incorrect expression <code>{unclosed</code> will return <code>{unclosed</code> as output. The leaves incorrect URLs to be handled by your URL library of choice.</p>
