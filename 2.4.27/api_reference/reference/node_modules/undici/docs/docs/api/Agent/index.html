...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.27/api_reference/reference/node_modules/undici/docs/docs/api/Agent/">
      
      
        <link rel="prev" href="../../../../">
      
      
        <link rel="next" href="../BalancedPool/">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#new-undiciagentoptions" class="md-nav__link">
    <span class="md-ellipsis">
    ...
    <nav class="md-nav" aria-label="new undici.Agent([options])">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#parameter-agentoptions" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#instance-properties" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Instance Properties">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#agentclosed" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.closed
          ...
          <li class="md-nav__item">
  <a href="#agentdestroyed" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#instance-methods" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Instance Methods">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#agentclosecallback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.close([callback])
          ...
          <li class="md-nav__item">
  <a href="#agentdestroyerror-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.destroy([error, callback])
          ...
          <li class="md-nav__item">
  <a href="#agentdispatchoptions-handler-agentdispatchoptions" class="md-nav__link">
    <span class="md-ellipsis">
    ...
    <nav class="md-nav" aria-label="Agent.dispatch(options, handler: AgentDispatchOptions)">
      <ul class="md-nav__list">
  ...
  <a href="#parameter-agentdispatchoptions" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Parameter: AgentDispatchOptions
          ...
          <li class="md-nav__item">
  <a href="#agentconnectoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.connect(options[, callback])
          ...
          <li class="md-nav__item">
  <a href="#agentdispatchoptions-handler" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.dispatch(options, handler)
          ...
          <li class="md-nav__item">
  <a href="#agentpipelineoptions-handler" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.pipeline(options, handler)
          ...
          <li class="md-nav__item">
  <a href="#agentrequestoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.request(options[, callback])
          ...
          <li class="md-nav__item">
  <a href="#agentstreamoptions-factory-callback" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        Agent.stream(options, factory[, callback])
          ...
          <li class="md-nav__item">
  <a href="#agentupgradeoptions-callback" class="md-nav__link">
    <span class="md-ellipsis">
...
<p>Agent allow dispatching requests against multiple different origins.</p>
<p>Requests are not guaranteed to be dispatched in order of invocation.</p>
<h2 id="new-undiciagentoptions"><code>new undici.Agent([options])</code></h2>
<p>Arguments:</p>
<ul>
<li><strong>options</strong> <code>AgentOptions</code> (optional)</li>
</ul>
<p>Returns: <code>Agent</code></p>
<h3 id="parameter-agentoptions">Parameter: <code>AgentOptions</code></h3>
...
<p>Implements <a href="../Dispatcher/#dispatcherdestroyerror-callback-promise"><code>Dispatcher.destroy([error, callback])</code></a>.</p>
<h3 id="agentconnectoptions-callback"><code>Agent.connect(options[, callback])</code></h3>
<p>See <a href="../Dispatcher/#dispatcherconnectoptions-callback"><code>Dispatcher.connect(options[, callback])</code></a>.</p>
<h3 id="agentdispatchoptions-handler"><code>Agent.dispatch(options, handler)</code></h3>
<p>Implements <a href="../Dispatcher/#dispatcherdispatchoptions-handler"><code>Dispatcher.dispatch(options, handler)</code></a>.</p>
<h3 id="agentpipelineoptions-handler"><code>Agent.pipeline(options, handler)</code></h3>
<p>See <a href="../Dispatcher/#dispatcherpipelineoptions-handler"><code>Dispatcher.pipeline(options, handler)</code></a>.</p>
<h3 id="agentrequestoptions-callback"><code>Agent.request(options[, callback])</code></h3>
<p>See <a href="../Dispatcher/#dispatcherrequestoptions-callback"><code>Dispatcher.request(options [, callback])</code></a>.</p>
<h3 id="agentstreamoptions-factory-callback"><code>Agent.stream(options, factory[, callback])</code></h3>
...
<h3 id="agentupgradeoptions-callback"><code>Agent.upgrade(options[, callback])</code></h3>
