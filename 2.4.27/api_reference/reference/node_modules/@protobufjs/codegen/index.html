...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://dfir-iris.org/2.4.27/api_reference/reference/node_modules/%40protobufjs/codegen/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.7.1">
        ...
        <title>@protobufjs/codegen - Documentation</title>
...
<script>window.plausible = window.plausible || function() { (window.plausible.q = window.plausible.q || []).push(arguments) }</script>
    ...
    <div data-md-component="skip">
        ...
        <a href="#protobufjscodegen" class="md-skip">
          Skip to content
        </a>
...
<p><a href="https://www.npmjs.com/package/@protobufjs/codegen"><img alt="npm" src="https://img.shields.io/npm/v/@protobufjs/codegen.svg" /></a></p>
<p>A minimalistic code generation utility.</p>
<h2 id="api">API</h2>
<ul>
<li>
<p><strong>codegen([functionParams: <code>string[]</code>], [functionName: string]): <code>Codegen</code></strong><br />
  Begins generating a function.</p>
</li>
<li>
<p><strong>codegen.verbose = <code>false</code></strong><br />
...
<ul>
<li>
<p><strong>Codegen(formatString: <code>string</code>, [...formatParams: <code>any</code>]): Codegen</strong><br />
...
<li>
<p><code>%d</code>: Number (integer or floating point value)</p>
</li>
<li><code>%f</code>: Floating point value</li>
<li><code>%i</code>: Integer value</li>
<li><code>%j</code>: JSON.stringify'ed value</li>
<li><code>%s</code>: String value</li>
<li>
<p><code>%%</code>: Percent sign<br /></p>
</li>
<li>
<p><strong>Codegen([scope: <code>Object.&lt;string,*&gt;</code>]): <code>Function</code></strong><br />
  Finishes the function and returns it.</p>
</li>
<li>
<p><strong>Codegen.toString([functionNameOverride: <code>string</code>]): <code>string</code></strong><br />
  Returns the function as a string.</p>
</li>
</ul>
<h2 id="example">Example</h2>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a><span class="kd">var</span><span class="w"> </span><span class="nx">codegen</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;@protobufjs/codegen&quot;</span><span class="p">);</span>
<a id="__codelineno-0-2" name="__codelineno-0-2" href="#__codelineno-0-2"></a>
<a id="__codelineno-0-3" name="__codelineno-0-3" href="#__codelineno-0-3"></a><span class="kd">var</span><span class="w"> </span><span class="nx">add</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">codegen</span><span class="p">([</span><span class="s2">&quot;a&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;b&quot;</span><span class="p">],</span><span class="w"> </span><span class="s2">&quot;add&quot;</span><span class="p">)</span><span class="w"> </span><span class="c1">// A function with parameters &quot;a&quot; and &quot;b&quot; named &quot;add&quot;</span>
<a id="__codelineno-0-4" name="__codelineno-0-4" href="#__codelineno-0-4"></a><span class="w">  </span><span class="p">(</span><span class="s2">&quot;// awesome comment&quot;</span><span class="p">)</span><span class="w">             </span><span class="c1">// adds the line to the function&#39;s body</span>
<a id="__codelineno-0-5" name="__codelineno-0-5" href="#__codelineno-0-5"></a><span class="w">  </span><span class="p">(</span><span class="s2">&quot;return a + b - c + %d&quot;</span><span class="p">,</span><span class="w"> </span><span class="mf">1</span><span class="p">)</span><span class="w">       </span><span class="c1">// replaces %d with 1 and adds the line to the body</span>
<a id="__codelineno-0-6" name="__codelineno-0-6" href="#__codelineno-0-6"></a><span class="w">  </span><span class="p">({</span><span class="w"> </span><span class="nx">c</span><span class="o">:</span><span class="w"> </span><span class="mf">1</span><span class="w"> </span><span class="p">});</span><span class="w">                        </span><span class="c1">// adds &quot;c&quot; with a value of 1 to the function&#39;s scope</span>
<a id="__codelineno-0-7" name="__codelineno-0-7" href="#__codelineno-0-7"></a>
<a id="__codelineno-0-8" name="__codelineno-0-8" href="#__codelineno-0-8"></a><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">add</span><span class="p">.</span><span class="nx">toString</span><span class="p">());</span><span class="w"> </span><span class="c1">// function add(a, b) { return a + b - c + 1 }</span>
<a id="__codelineno-0-9" name="__codelineno-0-9" href="#__codelineno-0-9"></a><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">add</span><span class="p">(</span><span class="mf">1</span><span class="p">,</span><span class="w"> </span><span class="mf">2</span><span class="p">));</span><span class="w">      </span><span class="c1">// calculates 1 + 2 - 1 + 1 = 3</span>
</code></pre></div>
